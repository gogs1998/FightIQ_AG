...
def optimize_strategy_isotonic():
    print("=== Strategy Optimization Grid Search (Isotonic Calibration) ===")
    ...
    kelly_fracs = [0.25, 0.125, 0.0625] # Added 1/4 Kelly for more aggression
        ...
        for max_odds in max_odds_list:
            for k_frac in kelly_fracs:
                for conf in conf_thresholds:
                    ...
                    # Optimize for Total Profit this time (Growth)
