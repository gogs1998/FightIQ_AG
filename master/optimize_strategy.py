...
def optimize_strategy():
    ...
    # Calibration: 2023-2024 (More data for calibration)
    ...
    # 5. Grid Search
    # Parameters to test:
    # - Min Edge: Minimum edge required to bet (e.g. 0%, 2%, 5%)
    # - Max Odds: Cap on odds (e.g. 2.5, 3.0, 4.0)
    # - Kelly Fraction: 1/4, 1/8, 1/16
    # - Confidence Threshold: Only bet if prob > X (e.g. 0.55, 0.60)
